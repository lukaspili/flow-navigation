...
public class ScreenScoper {
    ...
    public MortarScope getScreenScope(Context context, String name, Path path) {
        ...
        Log.d(getClass().getCanonicalName(), "Flow navigation - Screen scoper with parent " + parentScope.getName());

        MortarScope childScope = parentScope.findChild(name);
        if (childScope != null) {
            Log.d(getClass().getCanonicalName(), "Flow navigation - Screen scoper returns existing scope " + name);
            return childScope;
        }
        ...
        Log.d(getClass().getCanonicalName(), "Flow navigation - Screen scoper builds and returns new scope " + name);
